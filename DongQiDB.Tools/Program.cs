...
var dbPath = Path.Combine("..", "testdb.db");
...
var products = new[] {
    ("iPhone 15", "电子产品", 7999.0, 100), ("MacBook Pro", "电子产品", 14999.0, 50),
    ("AirPods Pro", "电子产品", 1999.0, 200), ("T恤", "服装", 199.0, 500),
    ("牛仔裤", "服装", 399.0, 300), ("连衣裙", "服装", 599.0, 150),
    ("有机苹果", "食品", 29.9, 1000), ("矿泉水", "食品", 2.5, 5000),
    ("《C#高级编程》", "图书", 199.0, 200), ("《算法导论》", "图书", 159.0, 100),
    ("办公桌", "家居", 899.0, 50), ("人体工学椅", "家居", 1299.0, 80),
};
...
var names = new[] { "张三", "李四", "王五", "赵六", "孙七", "周八", "吴九", "郑十", "王小明", "李小红", "张伟", "刘洋", "陈静", "杨帆", "黄磊", "林志玲", "刘德华", "周杰伦", "张学友", "王菲", "邓超", "黄晓明", "孙俪", "胡歌" };
...
Console.WriteLine("=== Mock Data Created ===");
